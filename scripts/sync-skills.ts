...
interface SkillsConfig {
    bundled: { name: string; category: SkillCategory }[];
...
function main(): void {
    ...
    try {
        ...
        console.log(`Catalog: ${routerEntries.length} routers, ${bundledEntries.length} bundled, ${upstreamEntries.length} upstream skills`);
